...
#if (defined(apollo) || defined(hpux) || defined(ibm) || defined(vms))
#   define spF77_CALL(proc) proc
#else
#   define spF77_CALL(proc) spcCONCAT(proc,_)
#endif
...
#ifdef hpux
/* These values are correct for hp9000/300, hp9000/700, and hp9000/800. */
/* Should be correct for others. */
#   define  MACHINE_RESOLUTION      8.9e-15
#   define  LARGEST_REAL            1.79769313486231e+308
#   define  SMALLEST_REAL           2.22507385850721e-308
#   define  LARGEST_SHORT_INTEGER   32766
...
/* Unknown machine, use conservative numbers. */
#ifndef MACHINE_RESOLUTION
#   define  MACHINE_RESOLUTION      8.9e-15
#   define  LARGEST_REAL            1.70141e+38
#   define  SMALLEST_REAL           2.938743e-39
#   define  LARGEST_SHORT_INTEGER   32766
